...
const PaymentHistoryTable = () => {
  ...
  const fetchData = async () => {
    ...
    console.log('Fetching data with query:', query);  // Log the query string
  ...
  return (
    <div className="dashboard-grid-container">
      ...
      <div className="filter-controls">
        ...
        <select id="servicePriceId" value={servicePriceIdFilter} onChange={handleServicePriceIdFilterChange}>
